import { math, Vec2, View, _decorator, log } from "cc";
...
export default class Settings {
    ...
    public get DEFAULT_WIDTH(): number {
        return this.default_width;
    }
    public get DEFAULT_HEIGHT(): number {
    ...
    public get HALF_WIDTH(): number {
        return this.half_width;
    }
    public get HALF_HEIGHT(): number {
        return this.half_heigth;
    }
    public get WORLD_WIDTH(): number {
        return this.world_width;
    }
    public get WORLD_HEIGHT(): number {
        return this.world_height;
    }
    public get SCALE(): number {
        return this.scale;
    }
    public get WIN_SIZE(): Vec2 {
        return math.v2(this.GAME_WIDTH, this.GAME_HEIGHT);
    }
    public get INV_WIN_SIZE(): Vec2 {
        return math.v2(1 / this.GAME_WIDTH, 1 / this.GAME_HEIGHT);
    }
    public get SIDE_RATIO(): number {
        return (
            Math.max(this.GAME_WIDTH, this.GAME_HEIGHT) /
            Math.min(this.GAME_WIDTH, this.GAME_HEIGHT)
        );
    }

    public set WORLD_WIDTH(value) {
        this.world_width = value;
    }
    public set WORLD_HEIGHT(value) {
        this.world_height = value;
    }
    ...
    chooseDefaultHeight() {
        const height = this.IS_LANDSCAPE
            ? this.DEFAULT_HEIGHT
            : this.DEFAULT_WIDTH;
        return height;
    }

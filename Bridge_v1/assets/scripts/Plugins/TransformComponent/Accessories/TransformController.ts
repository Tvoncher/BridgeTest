...
export default class TransformController {
    ...
    private _changeValueType: TransformComponentType =
        TransformComponentType.PositionAndScale;

    @property({ type: PositionComponent })
    private _positionComponent: PositionComponent = new PositionComponent();
    @property({ type: ScaleComponent })
    private _scaleComponent: ScaleComponent = new ScaleComponent();
    @property({ type: RotationComponent })
    private _rotationComponent: RotationComponent = new RotationComponent();
    @property({ type: AnchorComponent })
    private _anchorComponent: AnchorComponent = new AnchorComponent();
    @property({ type: SizeComponent }) private _sizeComponent: SizeComponent =
        new SizeComponent();

    @property({ type: Enum(TransformComponentType) })
    public get changeValueType(): TransformComponentType {
        return this._changeValueType;
    }
    public set changeValueType(v: TransformComponentType) {
        this._changeValueType = v;
    }
    ...
    public set positionComponent(v: PositionComponent) {
        this._positionComponent = v;
    }
    ...
    public get scaleComponent(): ScaleComponent {
        return this._scaleComponent;
    }
    public set scaleComponent(v: ScaleComponent) {
        this._scaleComponent = v;
    }
    ...
    public get rotationComponent(): RotationComponent {
        return this._rotationComponent;
    }
    public set rotationComponent(v: RotationComponent) {
        this._rotationComponent = v;
    }
    ...
    public get anchorComponent(): AnchorComponent {
        return this._anchorComponent;
    }
    public set anchorComponent(v: AnchorComponent) {
        this._anchorComponent = v;
    }
    ...
    public get sizeComponent(): SizeComponent {
        return this._sizeComponent;
    }
    public set sizeComponent(v: SizeComponent) {
        this._sizeComponent = v;
    }
    ...
    public set transformReference(v: Node) {
        ...
        if (this.positionComponent)
            this.positionComponent.isTransformReferenceExists =
                !!this._transformReference;
        if (this.scaleComponent)
            this.scaleComponent.isTransformReferenceExists =
                !!this._transformReference;
        if (this.rotationComponent)
            this.rotationComponent.isTransformReferenceExists =
                !!this._transformReference;
        if (this.anchorComponent)
            this.anchorComponent.isTransformReferenceExists =
                !!this._transformReference;
        if (this.sizeComponent)
            this.sizeComponent.isTransformReferenceExists =
                !!this._transformReference;
    }
    ...
    private isPreferredTypeSelected(
